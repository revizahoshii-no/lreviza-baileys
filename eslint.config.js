...
module.exports = [
    ...
    },
    {
        ...
        settings: {
            ...
            'import/internal-regex': '^@revizahoshii/hoshino-',
            'import/resolver': {
                node: {
        ...
        rules: {
            'no-restricted-imports': [
                'error',
                {
                    patterns: [
                        {
                            group: ['@revizahoshii/hoshino', '@revizahoshii/hoshino/*'],
                            message:
                                'fake-server Layer 2/3 must not import @revizahoshii/hoshino. Add the primitive to src/transport/ and import from there.'
                        }
                    ]
                }
            ]
    ...
    },
    {
        ...
        // with the real @revizahoshii/hoshino side to validate that they interoperate.
