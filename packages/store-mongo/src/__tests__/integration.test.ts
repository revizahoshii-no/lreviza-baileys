...
const host = process.env.HOSHINO_TEST_MONGO_HOST
const port = process.env.HOSHINO_TEST_MONGO_PORT
let sessionSeed = 0
...
describe('store-mongo integration', { timeout: 60_000 }, () => {
    ...
    it('auth: save, load, clear', async (t) => {
        if (!store) return t.skip('HOSHINO_TEST_MONGO_* not set')
