import type { WaPrivacyTokenStore, WaStoredPrivacyTokenRecord } from '@revizahoshii/hoshino/store'
import { asNumber, asOptionalBytes, asOptionalNumber, asString } from '@revizahoshii/hoshino/util'
