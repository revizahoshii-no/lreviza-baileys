import { signalAddressKey } from '@revizahoshii/hoshino/protocol'
import {
...
import type { WaIdentityStore as WaIdentityStoreContract } from '@revizahoshii/hoshino/store'
import { asNumber, asString, resolvePositive } from '@revizahoshii/hoshino/util'
