import type { Logger } from '@revizahoshii/hoshino'
...
export interface WaSqliteStoreConfig {
     ...
     * across `@revizahoshii/hoshino` and the rest of your application.
     */
 ...
 * createSqliteStore(...) }, providers: { ... } })` from `@revizahoshii/hoshino`.
 *
