import { isUserJid } from '@revizahoshii/hoshino'
import type { WaContactStore as Contract, WaStoredContactRecord } from '@revizahoshii/hoshino/store'
import { asNumber, asOptionalString, asString } from '@revizahoshii/hoshino/util'
