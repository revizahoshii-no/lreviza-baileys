#!/usr/bin/env node
/** Standalone CLI for `@revizahoshii/hoshino-fake-server`. */
...
function printHelp(): void {
    process.stdout.write(`@revizahoshii/hoshino-fake-server – standalone fake WhatsApp Web server

USAGE
  npx @revizahoshii/hoshino-fake-server [flags]
    ...
    if (!args.quiet) {
        ...
        if (args.json) {
            ...
            const banner = [
                '',
                '┌─────────────────────────────────────────────────────────────',
                '│ @revizahoshii/hoshino-fake-server is up',
                '├─────────────────────────────────────────────────────────────',
                `│ url            ${server.url}`,
                `│ host           ${server.host}`,
                `│ port           ${server.port}`,
