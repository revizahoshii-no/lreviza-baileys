 ...
 *
 * Tunables:
 *   HOSHINO_BENCH_RECEIPTS      (default 5000)
 *   HOSHINO_BENCH_RECEIPT_TYPES (default "delivery,read") types to cycle
 *
...
async function main(): Promise<void> {
    ...
    const totalReceipts = readPositiveIntEnv('HOSHINO_BENCH_RECEIPTS', 5_000)
    const typesRaw = readCsvEnv('HOSHINO_BENCH_RECEIPT_TYPES', ['delivery', 'read'])
    ...
    console.log('@revizahoshii/hoshino receipts-flood bench')
    console.log('────────────────────────────')
