import { type Logger, type LogLevel, type WaClientPluginContext } from '@revizahoshii/hoshino'
import { WA_MESSAGE_TAGS } from '@revizahoshii/hoshino/protocol'
...
export class WaVoipCoordinator {
    ...
    constructor(ctx: WaClientPluginContext, options: WaVoipCoordinatorOptions = {}) {
        this.deps = ctx.deps
        this.logger = ctx.logger.child({ scope: '@revizahoshii/hoshino-voip' }, { level: options.logLevel })
