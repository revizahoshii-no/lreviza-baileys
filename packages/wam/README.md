# @revizahoshii/hoshino-wam

WhatsApp Web **WAM** (analytics/telemetry) plugin for [@revizahoshii/hoshino](../../). It emits
...
```sh
npm install @revizahoshii/hoshino-wam
```

`@revizahoshii/hoshino` is a peer dependency. The WAM event registry
