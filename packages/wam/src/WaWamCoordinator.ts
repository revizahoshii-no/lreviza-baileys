...
import type { Logger, LogLevel, WaClientPluginContext } from '@revizahoshii/hoshino'
...
export class WaWamCoordinator {
    ...
    constructor(ctx: WaClientPluginContext, options: WaWamCoordinatorOptions = {}) {
        this.logger = ctx.logger.child({ scope: '@revizahoshii/hoshino-wam' }, { level: options.logLevel })
