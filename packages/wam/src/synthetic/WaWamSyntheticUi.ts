...
import type { BinaryNode, WaClientPluginContext, WaIncomingMessageEvent } from '@revizahoshii/hoshino'
import { isGroupJid, isLidJid, WA_ADDRESSING_MODES, WA_MESSAGE_TAGS } from '@revizahoshii/hoshino/protocol'
