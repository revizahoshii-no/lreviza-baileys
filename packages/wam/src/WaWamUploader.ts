import type { BinaryNode, Logger, WaClientPluginContext } from '@revizahoshii/hoshino'
import { WA_DEFAULTS, WA_IQ_TYPES, WA_NODE_TAGS } from '@revizahoshii/hoshino/protocol'
import { delay, toError } from '@revizahoshii/hoshino/util'
