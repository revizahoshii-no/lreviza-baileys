# @revizahoshii/hoshino-store-mysql

MySQL / MariaDB-backed persistent store for [`@revizahoshii/hoshino`](https://www.npmjs.com/package/@revizahoshii/hoshino). Built on [`mysql2/promise`](https://github.com/sidorares/node-mysql2). Suitable when your stack standardizes on MySQL/MariaDB and you want session state to ride the same backup, replication and IAM as the rest of your data.
...
```bash
npm install @revizahoshii/hoshino-store-mysql mysql2
```
...
import { createMysqlStore } from '@revizahoshii/hoshino-store-mysql'
