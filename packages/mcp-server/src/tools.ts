import * as HoshinoLib from '@revizahoshii/hoshino'
...
const resolveRoot = async (
    ...
    if (root === 'lib') {
        return { object: HoshinoLib as unknown as Record<string, unknown>, label: '@revizahoshii/hoshino' }
    }
...
const callTool: ToolDefinition = {
    ...
    description:
        ...
        'Roots: "client" (default) = WaClient instance; "lib" = the @revizahoshii/hoshino module namespace ' +
    ...
    inputSchema: {
        ...
        properties: {
            root: {
                ...
                enum: ['client', 'lib'],
                description:
                    '"client" (default) walks WaClient instance; "lib" walks the @revizahoshii/hoshino module namespace (no client init needed).'
            },
            path: {
                type: 'string',
                description:
...
const inspectTool: ToolDefinition = {
    ...
    description:
        ...
        'Roots: "client" (default) = WaClient instance + coordinators; "lib" = the @revizahoshii/hoshino module namespace ' +
    ...
    inputSchema: {
        ...
        properties: {
            root: {
                ...
                enum: ['client', 'lib'],
                description:
                    '"client" (default) inspects WaClient; "lib" inspects the @revizahoshii/hoshino module namespace.'
            },
            path: {
                type: 'string',
...
const evalTool: ToolDefinition = {
    ...
    description:
        ...
        '`session`, default session when omitted) and `lib` (@revizahoshii/hoshino module namespace) in ' +
    ...
    handler: async (input, runtime) => {
        ...
        const invoked = fn(client, HoshinoLib)
        if (noAwait) {
