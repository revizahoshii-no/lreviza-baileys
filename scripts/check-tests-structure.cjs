...
if (missingTestsDirectories.length > 0) {
    console.error('[hoshino] missing __tests__ coverage for source directories:')
...
console.log(
    `[hoshino] test structure check passed (${directoriesWithSource.length} source directories validated)`
)
