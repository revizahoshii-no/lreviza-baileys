 ...
 * in-tree `@revizahoshii/hoshino-store-*` package ships.
 *
...
> {
    ...
    readonly providers?: {
         ...
         * (e.g. `@revizahoshii/hoshino-store-sqlite`) in production so the device
     ...
     * silent. Backend packages (e.g. `@revizahoshii/hoshino-store-sqlite`,
     * `@revizahoshii/hoshino-store-redis`) receive a `child({ scope: 'store', provider:
