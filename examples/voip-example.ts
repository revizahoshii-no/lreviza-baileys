/**
 * Runnable VOIP smoke test for `@revizahoshii/hoshino-voip`.
 *
...
import { createPinoLogger, createStore, type LogLevel, WaClient } from '@revizahoshii/hoshino'

import { createSqliteStore } from '@revizahoshii/hoshino-store-sqlite'
import { CallState, EndCallReason, voipPlugin } from '@revizahoshii/hoshino-voip'
